...
import { Textarea } from "@ocean-dataview/dataview/components/ui/textarea";
...
function InputGroupAddon({
	...
	return (
		...
		// biome-ignore lint/a11y/noNoninteractiveElementInteractions: click handler focuses input for convenience
		<div
