...
import { ListContext, type ListContextValue } from "./list-context";
...
>({
	...
	className,
	pagination,
}: ListProviderProps<TData, TProperties>) {
	...
	const contextValue = useMemo<ListContextValue<TData, TProperties>>(
		() => ({
			data,
			properties,
			propertyVisibility,
