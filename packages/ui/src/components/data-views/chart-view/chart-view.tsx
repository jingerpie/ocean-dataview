...
import {
	getChartColors,
	getChartHeight,
} from "@ocean-dataview/ui/lib/data-views/utils/chart-colors";
import {
	type ChartDataPoint,
...
} from "@ocean-dataview/ui/lib/data-views/utils/compute-data";
import { transformData } from "@ocean-dataview/ui/lib/data-views/utils/transform-data";
import { validateChartConfig } from "@ocean-dataview/ui/lib/data-views/utils/validate-chart-config";
...
export function ChartView<
	TData,
	TProperties extends
		readonly import("@ocean-dataview/ui/lib/data-views/types").DataViewProperty<TData>[] = import("@ocean-dataview/ui/lib/data-views/types").DataViewProperty<TData>[],
